...
input_arguments = [
    ...
    InputArgument("batch_size", "bs", "batch_size (default: 256)", 256, int),
    InputArgument("topk", "topk", "topk (default: [1, 5, 10])", [1, 5, 10], int, nargs="+"),
    InputArgument("mask_ratios", "mr", "mask_ratios (default: [0.25, 0.5])", [0.25, 0.5], float, nargs="+"),
    ...
    InputArgument("use_pos_embedding", "upe", "Whether to use embeddings for positions (default: True)", True, str2bool,
                  nargs="?", const=True),
    InputArgument("number_of_heads", "nheads", "number of heads for attention (default: 4)", 4, int),
